...
1.	Please print & fill "Payment Application Form" according to the following information and submit it to <b>Gavin Cao</b> for Payment approval. 
2.	Upon approval, please submit the completed form to <b>HR</b>:

<table border="0" cellpadding="3" cellspacing="1"  style="background-color: #000000;width:500px"><tr bgcolor='#ffffff'><td>Name</td><td>Date</td><td>Explanation</td><td>Amount</td></tr><?php foreach ($arrMainData as $arrData){ if($arrData["employeeId"] == $addtionalData["employeeId"]){?><tr bgcolor='#ffffff'><td><?php echo $arrData['username'];?></td><td><?php echo $arrData['date'];?></td><td><?php echo $arrData['explanation'];?></td><td>￥<?php echo $arrData['amount'];?></td></tr><?php }}?></table>
